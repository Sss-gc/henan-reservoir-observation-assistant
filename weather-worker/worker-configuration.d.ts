/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=weather-worker/wrangler.jsonc weather-worker/worker-configuration.d.ts` (hash: 6a178cf894d4802dae3b1821438f39cd)
