/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b9f3ccc9f8be059a6ceb63ca940d9a6c)
// Runtime types generated with workerd@1.20260911.1 2026-09-14 nodejs_compat
interface __BaseEnv_Env {
	WEATHER_KV: KVNamespace;
	AUTH_EMAIL: "306221976@qq.com";
	CDSE_S3_ACCESS_KEY: string;
	CDSE_S3_SECRET_KEY: string;
	CDSE_CLIENT_ID: string;
	CDSE_CLIENT_SECRET: string;
	USGS_USERNAME: string;
	USGS_M2M_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_EMAIL" | "CDSE_S3_ACCESS_KEY" | "CDSE_S3_SECRET_KEY" | "CDSE_CLIENT_ID" | "CDSE_CLIENT_SECRET" | "USGS_USERNAME" | "USGS_M2M_TOKEN" | "VITE_TIANDITU_KEY">> {}
}
